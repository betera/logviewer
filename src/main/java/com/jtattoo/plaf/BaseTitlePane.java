        ...
        implements TitlePane
{
    ...
    protected void setState(int state, boolean updateRegardless)
    {
        if ( window != null && getWindowDecorationStyle() == BaseRootPaneUI.FRAME )
        {
            ...
            if ( frame != null )
            {
                ...
                if ( ((state & BaseRootPaneUI.MAXIMIZED_BOTH) != 0) && (rootPane.getBorder() == null
    ...
    public void paintBackground(Graphics g)
    {
        if ( isActive() )
        {
            ...
            JTattooUtilities.fillHorGradient(g,
                                             AbstractLookAndFeel.getTheme().getWindowTitleColors(),
                                             0,
                                             0,
                                             getWidth(),
                                             getHeight());
            ...
            implements LayoutManager
    {
        ...
        public void layoutDefault(Container c)
        {
            ...
            {
                if ( DecorationHelper.isFrameStateSupported(Toolkit.getDefaultToolkit(),
