...
public class BaseBorders
{
    ...
    public static Border getProgressBarBorder()
    {
        ...
        {
            progressBarBorder =
                    BorderFactory.createLineBorder(ColorHelper.darker(AbstractLookAndFeel.getBackgroundColor(), 30));
        }
    ...
    public static Border getDesktopIconBorder()
    {
        ...
        {
            desktopIconBorder =
                    new BorderUIResource.CompoundBorderUIResource(new LineBorder(AbstractLookAndFeel.getWindowBorderColor(),
                                                                                 1),
                                                                  new MatteBorder(2,
                                                                                  2,
                                                                                  1,
            ...
            implements UIResource
    {
        ...
        public void paintLogo(Component c, Graphics g, int x, int y, int w, int h)
        {
            if ( hasLogo(c) )
            {
                ...
                String logo = JTattooUtilities.getClippedText(AbstractLookAndFeel.getTheme().getLogoString(),
                                                              fm,
                                                              h - 16);
...
//                    JTattooUtilities.drawString((JComponent) c, g, logo, 1, 0);
        ...
        public Insets getBorderInsets(Component c)
        {
            if ( hasLogo(c) )
            {
                if ( JTattooUtilities.isLeftToRight(c) )
                {
                    return new Insets(leftLogoInsets.top,
                                      leftLogoInsets.left,
                ...
                {
                    return new Insets(rightLogoInsets.top,
            ...
            implements UIResource
    {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h)
        {
            ...
            JTattooUtilities.draw3DBorder(g,
                                          ...
                                          ColorHelper.brighter(frameColor, 80),
                                          x,
                                          y,
                                          w,
                                          h);
