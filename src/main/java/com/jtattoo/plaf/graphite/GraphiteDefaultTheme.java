...
public class GraphiteDefaultTheme
        extends AbstractTheme
{
    ...
    public void setUpColor()
    {
        ...
        menuSelectionBackgroundColorLight = new ColorUIResource(173, 213, 255);
        menuSelectionBackgroundColorDark = new ColorUIResource(120, 168, 240);
