 ...
 */
public class GraphiteLookAndFeel
        extends AbstractLookAndFeel
{
    ...
    protected void initClassDefaults(UIDefaults table)
    {
        ...
        Object[] uiDefaults = {
                ...
                "MenuBarUI", BaseMenuBarUI.class.getName(), "PopupMenuUI", BasePopupMenuUI.class.getName(),
                "PopupMenuSeparatorUI", BaseSeparatorUI.class.getName(), "DesktopPaneUI",
